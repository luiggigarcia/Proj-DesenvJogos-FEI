...
- A ideia principal do jogo é criar uma experiência arcade 2D baseada em reflexos e precisão, na qual o jogador controla um personagem que deve atravessar obstáculos gerados dinamicamente, mantendo-se em movimento constante.
...
Interface limpa, poucos elementos na tela e foco total na jogabilidade. A proposta é entregar uma experiência arcade clássica: simples de entender, difícil de dominar.
